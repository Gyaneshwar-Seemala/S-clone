    ...
    return (
        <div className='w-[20%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'>
            ...
            <div className='bg-[#121212] h-[85%] rounded'>
                ...
                <div className='p-4 bg-[#242424] m-2 rounded text-lg font-semibold flex flex-col items-start justify-start gap-1 pl-4'>
                    <h1>Create your first playlist</h1>
                    <p className='font-light text-sm'>Curate custom playlists for your music needs</p>
                    <button className='px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4'>Create Now</button>
                </div>
                <div className='p-4 bg-[#242424] m-2 rounded text-lg font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4'>
                    <h1>Find latest Podcasts</h1>
                    <p className='font-light text-sm'>Listen to your favorite podcasts on the go</p>
