    ...
    return (
        <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
            ...
            <div className='hidden lg:flex items-center gap-2 opacity-75'>
                <img src={assets.plays_icon} className='w-5 h-4 cursor-pointer' />
                <img src={assets.mic_icon} className='w-4 h-4 cursor-pointer' />
                <img src={assets.queue_icon} className='w-4 h-4 cursor-pointer' />
                <img src={assets.speaker_icon} className='w-4 h-5 cursor-pointer' />
                <img src={assets.volume_icon} className='w-4 h-5 cursor-pointer'   />
                <input
                    type='range'
                    min='0'
                    max='1'
                    ...
                    color='green'
                    className='w-20 h-1 bg-green-800 accent-green-700 cursor-pointer'
                />
                <img src={assets.mini_player_icon} className='h-4 w-4 cursor-pointer' />
                <img src={assets.zoom_icon} className='w-4 h-5 cursor-pointer' />
            </div>
        </div>
    );
};
